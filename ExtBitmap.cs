...
namespace Detection
{
    ...
    {
        public static Bitmap CopyToSquareCanvas1(this Bitmap sourceBitmap, int canvasWidthLenght)
        {
            float ratio = 1.0f;
           ...
           //code added
            Bitmap bitmapResult1 = sourceBitmap;
            //
                        ...
                        byte threshold = 0)
        {
            ...
            //code added
            //Bitmap resultBitmap1 = new Bitmap(bitmapResult1.Width, bitmapResult1.Height);
            //BitmapData resultData = resultBitmap1.LockBits(new Rectangle(0, 0,
            //                       resultBitmap1.Width, resultBitmap1.Height),
            //                       ImageLockMode.WriteOnly, PixelFormat.Format32bppArgb);

            //Marshal.Copy(resultBuffer, 0, resultData.Scan0, resultBuffer.Length);
            //resultBitmap1.UnlockBits(resultData);
        ...
        public static Bitmap StainedGlassColorFilter(this Bitmap sourceBitmap, 
                                                     ...
                                                     bool highlightEdges, 
                                                     byte edgeThreshold, Color edgeColor, Bitmap orignalsource)
        {
            BitmapData sourceData =
                       sourceBitmap.LockBits(new Rectangle(0, 0,
                       sourceBitmap.Width, sourceBitmap.Height),
            ...
            Bitmap resultBitmap1 = new Bitmap(orignalsource.Width,
                                            orignalsource.Height);

            BitmapData resultData =
                       resultBitmap1.LockBits(new Rectangle(0, 0,
                       resultBitmap1.Width, resultBitmap1.Height),
                       ImageLockMode.WriteOnly,
                       PixelFormat.Format32bppArgb);
            ...
            {
                resultBitmap1 = 
                resultBitmap1.GradientBasedEdgeDetectionFilter(edgeColor, edgeThreshold);
            }
