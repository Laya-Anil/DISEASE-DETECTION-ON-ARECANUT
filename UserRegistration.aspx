...
<body class="main-layout">
             ...
             <%--  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">--%>
                 <%-- <div class="plants-box">--%>
                      <form id="form2" runat="server"   style="background-color:White;" >
                        <div style="z-index: 102; left: 500px; width: 400px; position: absolute; top: 1000px; height: 700px">
                         <h1 style="font-family: 'Times New Roman', Times, serif; font-size: x-large; font-weight: bold; color: #000000"><span></span>User Registration</h1>  
                         <br />
      <asp:Label ID="Label13" runat="server" Text="Username:" Font-Bold="True" 
            Font-Names="Arial" Font-Size="Medium"></asp:Label><br /> 
        <asp:TextBox ID="TextBox8" runat="server" Height="32px" Width="325px" ></asp:TextBox>
             <br />     
                
          <asp:Label ID="Label15" runat="server" Text="Password:" Font-Bold="True" 
            Font-Names="Arial" Font-Size="Medium"></asp:Label><br /> 
        <asp:TextBox ID="TextBox10" runat="server" Height="32px" Width="325px" 
      ...
      <asp:Label ID="Label1" runat="server" Text="Name:" Font-Bold="True" 
            Font-Names="Arial" Font-Size="Medium"></asp:Label><br /> 
        <asp:TextBox ID="TextBox1" runat="server" Height="32px" Width="325px" ></asp:TextBox>
             <br />     
      ...
      <asp:Label ID="Label4" runat="server" Text="Mobile No:" Font-Bold="True" 
            Font-Names="Arial" Font-Size="Medium"></asp:Label><br /> 
        <asp:TextBox ID="TextBox3" runat="server" Height="32px" Width="325px" ></asp:TextBox>
             <br />     
             
      <asp:Label ID="Label5" runat="server" Text="Address:" Font-Bold="True" 
            Font-Names="Arial" Font-Size="Medium"></asp:Label><br /> 
        <asp:TextBox ID="TextBox4" runat="server" Height="144px" Width="325px" TextMode="MultiLine" ></asp:TextBox>
             <br />     
     ...
     <asp:Button 
        ...
        Width="165px"/> &nbsp;&nbsp;<asp:Button ID="Button2" 
